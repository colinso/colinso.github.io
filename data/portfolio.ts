  ...
  projects: [
    {
      ...
      title: "GameLog",
      description:
        "A Go-based application for tracking and logging gaming sessions and reviews",
    ...
    },
    {
      id: "ceramic-buddy",
      title: "Ceramic Buddy",
      description: "Pottery studio management tool built with React Native",
      longDescription:
        "A mobile application for pottery artists to manage inventory, track kiln firings, log glaze recipes, and organize their studio workflow.",
      technologies: ["React Native", "TypeScript", "Firebase"],
      githubUrl: "https://github.com/colinso/ceramic-buddy",
      featured: true,
      status: "Completed",
